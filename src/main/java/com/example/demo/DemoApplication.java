...
public class DemoApplication {
	...
	public static void main(String[] args) {
		...
		Produit p1= new Produit("p1",magasin,new Date(),"56565656");
		ProduitDao.save(p1);
		...
		FactureStockable fs1= new FactureStockable(new Long(40),50.0,70.0,p1,f1);
		...
		ProduitDao.save(new Produit("p2",magasin,new Date(),"8878"));
		ProduitDao.save(new Produit("p3",magasin,new Date(),"456"));
